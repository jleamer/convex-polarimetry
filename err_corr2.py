...
if __name__=="__main__":
    ...
    cost = [cp.abs(I[i][0] -cp.trace((l1.conj().T).dot(l1) @ J[i])) ** 2 + \
           cp.abs(I[i][1] -cp.trace((l2.conj().T).dot(l2) @ J[i])) ** 2 + \
           cp.abs(I[i][2] -cp.trace((l3.conj().T).dot(l3) @ J[i])) ** 2 + \
           cp.abs(I[i][3] -cp.trace((l4.conj().T).dot(l4) @ J[i])) ** 2 \
